...
class DictionaryService:
    """
    Dictionary service providing word validation and retrieval.
    This service is correct — do not modify.
    """

    async def is_valid_word(self, word: str) -> bool:
        """Check if a word is valid. Simulates async latency (10-50ms)."""
